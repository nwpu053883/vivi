...
static void my_vivid_timer_function(struct timer_list *list)
{
...
static int my_vivid_open(struct file *file)
{
    ...
    timer_setup(&my_vivid_timer, my_vivid_timer_function, 0);
